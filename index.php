...
$menu_items = ['Introduzione', 'Norme sulla privacy', 'Termini di servizio', 'Tecnologie','Domande frequenti'];
$footer_items = ['Google', 'Tutto su Google', 'Privacy', 'Termini'];
$languages = ['English', 'Italian', 'Flemish', 'Hebrew', 'German'];
?>
...
<body>
    <header>
        <div class="logo-side">
            <img src="img/pngegg.png" alt="" srcset="">
            <a class="logo-text">Privacy e termini<a>
        </div>
        <div class="user-side">
            <div class="icon-user">
